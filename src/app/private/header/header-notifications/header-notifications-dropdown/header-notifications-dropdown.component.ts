...
@Component({
  selector: 'vex-header-notifications-dropdown',
  templateUrl: './header-notifications-dropdown.component.html',
  styleUrls: ['./header-notifications-dropdown.component.scss'],
  standalone: true,
  imports: [
    MatButtonModule,
    MatMenuModule,
...
export class HeaderNotificationsDropdownComponent implements OnInit {
